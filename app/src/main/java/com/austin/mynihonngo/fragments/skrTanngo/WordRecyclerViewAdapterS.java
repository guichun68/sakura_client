...
public class WordRecyclerViewAdapterS extends Adapter<ViewHolder> implements Serializable{
    ...
    public WordRecyclerViewAdapterS(Context context, List<WordResult> data) {
