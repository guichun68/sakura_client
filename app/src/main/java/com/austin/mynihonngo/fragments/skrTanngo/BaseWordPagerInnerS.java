...
//                ctrlToolBarShowOrHide(recyclerView,dx,dy);
        ...
        adapter.setOnItemClickListener(new WordRecyclerViewAdapterS.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                UIUtil.showTestLog(TAG,"GlobalParams.globalWordAdapterS is assignment");
                GlobalParams.globalWordAdapterS = adapter;
                SharedPreferencesUtils.saveAdapterSToSP(mParentFrag.getActivity(),adapter);
//                Log.d(TAG, "item position = " + position);
    ...
    public void openNextWordDetailFrg(int currtPosition) {
        if(GlobalParams.globalWordAdapterS == null){
            Log.e(TAG,"GlobalParams.globalWordAdapterS==null");
            GlobalParams.globalWordAdapterS = SharedPreferencesUtils.readSakuraWordAdapter(mParentFrag.getContext());
            if(GlobalParams.globalWordAdapterS == null){
