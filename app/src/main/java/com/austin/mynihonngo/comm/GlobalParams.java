package com.austin.mynihonngo.comm;
...
import com.austin.mynihonngo.fragments.SkrBunnpo.SkrRecyclerViewAdapterB;
...
public class GlobalParams {
	...
	public static String URL_ABOUT_ME = GlobalParams.BASE_URL+"/pages/aboutme.html";
	...
	public static void refreshIP(){
		...
		URL_ABOUT_ME = GlobalParams.BASE_URL + "/pages/aboutme.html";
...
//	public static TabChangedListener tabChangedListener;
	public static IFragmentListener iWordSkaura;
