 ...
 */
public class BaseWordPager2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        titles = getArguments().getStringArray(ConstantValue.TitleArguBundle);
    ...
    public void initSpecifyTypeViews() {
        pagers.clear();
        BaseWordPager pagerType1=null,pagerType2=null,pagerType3=null,pagerType4=null;
        switch (wordType){
            ...
            case ConstantValue.WordTypeVerb:
                pagerType1 = new TangoFragBasePager(getActivity(), ConstantValue.VERB_TYPE_ONE, null);
                pagerType2 = new TangoFragBasePager(getActivity(), ConstantValue.VERB_TYPE_TWO, null);
                pagerType3 = new TangoFragBasePager(getActivity(), ConstantValue.VERB_TYPE_THREE, null);
            break;
            ...
            case ConstantValue.WordTypeOther:
                pagerType1 = new TangoFragBasePager(getActivity(), ConstantValue.OTHER_TYPE_ONE, null);
                pagerType2 = new TangoFragBasePager(getActivity(), ConstantValue.OTHER_TYPE_TWO, null);
                pagerType3 = new TangoFragBasePager(getActivity(), ConstantValue.OTHER_TYPE_ALL, null);
            break;
        }
