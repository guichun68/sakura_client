 ...
 * Desc: 单词中心之动词Fragment
 */
public class TanngoFragOfVerb extends Fragment {
    ...
    private void bindView() {
        ...
        titles = getActivity().getResources().getStringArray(R.array.verb_tab_title);
    }
    ...
    public void initSpecifyTypeViews() {
        pagers.clear();
        BaseWordPager pagerType1,pagerType2,pagerType3;
